python early:
    ...
    # outdented
    OUTDENT_KEYWORDS = { "define", "default", "image", "screen", "init", "transform", "label", "style", "layeredimage", "group", "attribute" }
...
transform example_transform(height, ypos):
    ...
    on show:
        crop (0, 0, 1920, 0)
        linear .5 crop (0, 0, 1920, height)

    on hide:
        linear .5 crop (0, 0, 1920, 0)
